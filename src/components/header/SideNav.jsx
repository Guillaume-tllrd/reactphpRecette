            ...
            <div className={`fixed top-0 bg-white left-0 h-full transition-transform duration-500 ease-out ${visible ? 'translate-x-0' : '-translate-x-full'} w-60 p-4 shadow-lg z-50`}>
                ...
                <nav className="mt-12">
                    <ul className="space-y-4">
                       ...
                       <li className='flex h-[48px] items-center hover:bg-slate-200 hover:text-orange-500'><Link className='flex gap-2 pl-2 text-lg' to='/recipes/breakfast'> <EggFried/> Breakfast</Link></li>

                       <li className='flex h-[48px] bg-gray-50 items-center hover:bg-slate-200 hover:text-white'><Link className='flex gap-2 pl-2 text-lg' to='/recipes/main'> <Utensils/>Main</Link></li>

                       <li className='flex h-[48px] items-center hover:bg-slate-200 hover:text-orange-500'><Link className='flex gap-2 pl-2 text-lg' to='/recipes/dessert'> <CakeSlice/> Dessert</Link></li>

                       <li className='flex h-[48px] bg-gray-50 items-center hover:bg-slate-200 hover:text-white'><Link className='flex gap-2 pl-2 text-lg' to='/recipes/appetizer'> <Sandwich/>Appetizer</Link></li>
                    </ul>
