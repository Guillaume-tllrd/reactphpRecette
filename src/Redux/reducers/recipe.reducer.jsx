        ...
        case EDIT_RECIPE:
                return {
                    ...
                    recipes: state.recipes.map((recipe) => 
                        ...
                        recipe.id === action.payload.id ? { ...recipe, name: action.payload.name, ingredients: action.payload.ingredients, description: action.payload.description, tags: action.payload.tags} 
                        : recipe
                    )
